...
class BannerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.banner = QPixmap(':/gallery/images/header.jpg')
        ...
        #     ':/gallery/images/LogosAirflowIcon.svg',
        #     self.tr('Getting started'),
        #     self.tr('An overview of User instructions'),
        #     HELP_URL
        # )
        #
        # self.linkCardView.addCard(
        ...
        #     self.tr('GitHub repo'),
        #     self.tr(
        #         'The latest complex lighting data set evaluation system'),
        #     REPO_URL
        # )
        #
        # self.linkCardView.addCard(
...
class HomeInterface(ScrollArea):
    ...
    def __initWidget(self):
        ...
        self.vBoxLayout.setContentsMargins(0, 0, 0, 18)
        self.vBoxLayout.setSpacing(40)
        self.vBoxLayout.addWidget(self.banner)
        self.vBoxLayout.setAlignment(Qt.AlignTop)

        # self.galleryLabel = QLabel("欢迎使用", self)
